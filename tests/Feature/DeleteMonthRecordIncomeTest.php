...
class DeleteMonthRecordIncomeTest extends TestCase
{
    use RefreshDatabase;

    public function test_delete_month_record_income(): void
    {
        //make fake Event
        Event::fake();
        ...
        $request = $this->postJson('/admin/api/del-record-income/month', [
            'stat' => 'income',
