...
class DeleteMonthRecordOnlineTest extends TestCase
{
    use RefreshDatabase;

    public function test_delete_month_record_online(): void
    {
        //make fake Event
        Event::fake();
        ...
        $request = $this->postJson('/admin/api/del-record-online/month', [
            'stat' => 'online',
