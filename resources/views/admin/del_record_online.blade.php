...
@section('title', 'Admin - delete online record')
...
@section('main')
    ...
    <div class="month-info">
        <form id="month-info">
            <input type="hidden" name="stat" value="online">
            <label>
                <b>Game ID:</b>
